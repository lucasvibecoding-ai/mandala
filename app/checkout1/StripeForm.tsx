...
export default function StripeForm({ email, onEmailChange, paypalEmail, totalLabel }: { email: string; onEmailChange: (v: string) => void; paypalEmail: string; totalLabel: string }) {
