    ...
    <Html>
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={optionText}>
            <strong>Option 2: Wait for the updated version.</strong> It&apos;s already in production and coming the first half of May. It&apos;s going to be incredible. As a thank you for your patience, I&apos;ll give you a <strong>steep discount</strong> on our private community once it opens. It&apos;s going to be a space for mandala enthusiasts, and you&apos;ll get in at a fraction of the price.
          </Text>
          ...
          <Text style={spamStep}>
            <strong>2. Add me to your contacts.</strong> Save <strong>hello@mandalapractice.com</strong> as a contact and future emails will go straight to your inbox.
          </Text>
